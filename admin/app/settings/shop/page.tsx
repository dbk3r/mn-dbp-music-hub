...
export default function ShopSettingsPage() {
  ...
  async function load() {
    try {
      ...
      const r = await fetch("/dbp-admin/api/shop-settings", { headers })
  ...
  async function save() {
    ...
    try {
      ...
      const r = await fetch("/dbp-admin/api/shop-settings", {
        method: "POST",
        headers,
  ...
  return (
    <div style={{ padding: 30, maxWidth: 800 }}>
      ...
      <p style={{ color: "#666", marginBottom: 20 }}>Verwalten Sie Shop-spezifische Einstellungen wie Steuersatz und Anzeigeoptionen.</p>
