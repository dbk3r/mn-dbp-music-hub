...
export async function POST(req: NextRequest) {
  ...
  console.log(`[admin proxy] POST /api/mfa/email/disable -> ${backendUrl(`/custom/admin/mfa/email/disable`)}`, body)
  const res = await fetch(backendUrl(`/custom/admin/mfa/email/disable`), {
    method: "POST",
