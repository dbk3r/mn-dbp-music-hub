...
export async function POST(req: NextRequest) {
  ...
  console.log(`[admin proxy] POST /api/mfa/email/start -> ${backendUrl(`/custom/admin/mfa/email/start`)}`, body)
  const res = await fetch(backendUrl(`/custom/admin/mfa/email/start`), {
    method: "POST",
